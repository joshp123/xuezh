...
---
    ...
    ## Deliverables
    - `chlearn report hsk --level L --window W --max-items N`
  - coverage, recency distribution, bounded evidence rows
- `chlearn report mastery --item-type character|word|grammar --window W --max-items N`
  - facts: last_seen, times_seen, success rates, due_at, pronunciation stats
- `chlearn report progress --window W`
