...
## Notes
Added deterministic ID helpers + tests, and enforced ID regex patterns in schemas where IDs are emitted
(event.log event_id/items, content.cache.put content_id).
