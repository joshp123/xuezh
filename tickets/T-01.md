...
## Notes
Verified existing scaffold: schemas present (envelope + command schemas), CLI flags include --limit/--max-bytes,
typed error codes enforced via error_types, and contract tests validate envelope + schemas.
