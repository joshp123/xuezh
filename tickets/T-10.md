...
---
    ...
    ## Deliverables
    - `chlearn audio assess --ref-text TEXT --in IN.wav --mode local|azure`
  - v0 local: simple structured diagnostics (placeholders ok)
  - v1 optional azure: behind feature flag + secrets (agenix outside repo)
- `chlearn audio process-voice --in voice.ogg --ref-text TEXT`
