...
## Notes
Added workspace creation + subdirs, safe path resolution within workspace, and daily backup path helper.
Unit tests cover traversal rejection and env overrides.
